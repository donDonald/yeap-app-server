...
util.inherits(LoggerFs, EventEmitter);
...
LoggerFs.prototype.close = function() {
...
LoggerFs.prototype.system = function(message) {
    this._write('system', message);
}

LoggerFs.prototype.fatal = function(message) {
    this._write('fatal', message);
}

LoggerFs.prototype.error = function(message) {
    this._write('error', message);
}

LoggerFs.prototype.warn = function(message) {
    this._write('warn', message);
}

LoggerFs.prototype.info = function(message) {
    this._write('info', message);
}

LoggerFs.prototype.debug = function(message) {
