...
describe('lib.services.Http, Complex service, some routes are here, access.js and  validator.js are here', function() {
    ...
    before(()=>{
        ...
        process.env.APP_ROOT = process.env.APP_ROOT + '/lib/services/tsrc/test.Http.complex';
    });
    ...
    describe('Stop not-yet-started service', ()=>{
        it('#Http.stop', (done)=>{
            const service = new api.lib.services.Http();
            assert.equal(false, service.isStarted());
            api.lib.services.Http.assertIsStopped(service);
    ...
    describe('Start and stop', ()=>{
        ...
        before((done)=>{
            service = new api.lib.services.Http();
        ...
        it('#Http.start', (done)=>{
            ...
            service.start(opts, (err)=>{
                ...
                api.lib.services.Http.assertIsStarted(service);
                done();
            });
        });
        ...
        it('Query, url: /news', (done)=>{
            api.lib.ajax.json.get(SESSION, DOMAIN, 'news', {}, {}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(!err, err);
        ...
        it('Query, url: /news?id=a', (done)=>{
            api.lib.ajax.json.get(SESSION, DOMAIN, 'news?id=a', {}, {}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(!err, err);
        ...
        it('Query, url: /news?id=b', (done)=>{
            api.lib.ajax.json.get(SESSION, DOMAIN, 'news?id=b', {}, {}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(!err, err);
        ...
        it('Query, url: /news?id=c', (done)=>{
            api.lib.ajax.json.get(SESSION, DOMAIN, 'news?id=c', {}, {}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(!err, err);
        ...
        it('Query not existing param, url: /news?id=cccccc', (done)=>{
            api.lib.ajax.json.get(SESSION, DOMAIN, 'news?id=cccccc', {}, {}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(!err, err);
        ...
        it('Query invalid params, url: /news?id=', (done)=>{
            api.lib.ajax.json.get(SESSION, DOMAIN, 'news?id=', {}, {}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
        ...
        it('Query, add incorrect element, url: /news/add', (done)=>{
            assert(!MODEL.news.d);
            api.lib.ajax.json.post(SESSION, DOMAIN, 'news/add', {}, {id:'d'}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(err);
        ...
        it('Query, add element, url: /news/add', (done)=>{
            assert(!MODEL.news.d);
            api.lib.ajax.json.post(SESSION, DOMAIN, 'news/add', {}, {id:'d', title:'ddd'}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
                assert(!err, err);
        ...
        it('Query, delete element, url: /news/delete', (done)=>{
            assert(MODEL.news.d);
            api.lib.ajax.json.delete(SESSION, DOMAIN, 'news/delete', {}, {id:'d'}, function(err, session, result) {
                //console.log('err:', err);
                //console.log('session:', session);
                //console.log('result:', result);
