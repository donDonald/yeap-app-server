...
describe('yeap_app_server.services.Http, testing SSL', ()=>{
    ...
    describe('Start and stop', ()=>{
        ...
        it('Query not existing url, url: /missing_route', (done)=>{
            const HTTP_404 =
`<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <title>The requested URL /missing_route is not found</title>
    <body>
</html>
`;

            ajax.text.get(SESSION, DOMAIN, 'missing_route', {}, {}, function(err, session, result) {
                //console.log('err:', err);
