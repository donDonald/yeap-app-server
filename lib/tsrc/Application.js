...
describe('lib.Application', function() {
    ...
    describe('Open app and close it', ()=>{
        ...
        it('#Verify app.config', ()=>{
            assert.equal(5, Object.keys(app.config).length);
            ...
            assert.equal('object', typeof app.config.session);
            assert.equal(2, Object.keys(app.config.session).length);
        ...
        it('Verify http service', ()=>{
            ...
            assert.equal(3, Object.keys(app.config.application.services.http).length);
