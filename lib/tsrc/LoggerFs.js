...
describe('app_server.LoggerFs', function() {

    const assert = require('assert');
    const helpers = require('./helpers');
    const DIR = '/tmp/api.app_server.LoggerFs/';
    ...
    describe('#Logger.open and Logger.close', ()=>{
        let logger;
        before(()=>{
            logger = new api.app_server.LoggerFs({path:DIR, streams:STREAMS});
        });
...
//              console.log('streams:', streams);
    ...
    const setUTCDate = (str)=>{
        ...
        api.app_server.LoggerFs.dateFoo = dateFoo.bind(undefined, dateValue);
    }

    describe('#LoggerFs.createStreamFileName', ()=>{
        it('04 Dec 1995 00:00:00 GMT', ()=>{
            setUTCDate('04 Dec 1995 00:00:00 GMT');
            const f = api.app_server.LoggerFs.createStreamFileName({_type:'system'});
//          console.log('f:', f);
        ...
        it('05 Dec 1995 14:15:16 GMT', ()=>{
            ...
            const f = api.app_server.LoggerFs.createStreamFileName({_type:'info'});
//          console.log('f:', f);
    ...
    describe('#LoggerFs.after', ()=>{
        it('04 Dec 1995 00:00:00 GMT', ()=>{
            setUTCDate('04 Dec 1995 00:00:00 GMT');
            const a = api.app_server.LoggerFs.after();
//          console.log('a:', a);
